...
```{r read-refs}
#| include: false
# Auto-generated from references.bib. Edit the .bib, then `make site`
# (which deletes the stale freeze and re-renders this page).
...
# biblatex-flavour parser. Handles nested braces by depth-tracking; assumes
# well-formed entries (our bib is hand-maintained, small, and stable).
...
# "A. One, B. Two, and C. Three" with **L. Burk** bolded
